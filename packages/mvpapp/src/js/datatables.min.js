 ...
 *   https://datatables.net/download/#bs-3.3.7/dt-1.10.15
 *
 * Included libraries:
 *   Bootstrap 3.3.7, DataTables 1.10.15
 */
    ...
    function Y(a) {
        ...
        h.each(a, function (e) {
            if ((b = e.match(/^([^A-Z]+?)([A-Z])/)) && -1 !== "a aa ai ao as b fn i m o s ".indexOf(b[1] + " "))
                (c = e.replace(b[0], b[2].toLowerCase())), (d[c] = e), "o" === b[1] && Y(a[e]);
        });
        a._hungarianMap = d;
    }
    function J(a, b, c) {
            ...
            m = function (a) {
                if (c === k || c === i)
                    (j = l[i]),
                        ...
                        j && j._bAttrSrc
                            ? (S(j.mData._)(d, n), r(j.mData.sort, a), r(j.mData.type, a), r(j.mData.filter, a))
                            : q
            ...
            if (0 !== i.length) {
                ...
                (c = f.sZeroRecords),
                    ...
                    (b[0] = h("<tr/>", { class: e ? d[0] : "" }).append(
                        h("<td />", { valign: "top", colSpan: ba(a), class: a.oClasses.sRowEmpty }).html(c)
                    )[0]);
    ...
    function wb(a) {
        ...
        for (g = 0; g < c; g++)
            (n = b[g]),
                ...
                r("mDataProp_" + g, i),
                d.bFilter &&
                    (r("sSearch_" + g, l.sSearch), r("bRegex_" + g, l.bRegex), r("bSearchable_" + g, n.bSearchable)),
            ...
            for (m = 0; m < i.length; m++)
                (p = c[i[m]]),
                    ...
                    p.sWidthOrig &&
                        f &&
                        h(n[m]).append(
                            h("<div/>").css({ width: p.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 })
                        );
            if (a.aoData.length)
                for (m = 0; m < i.length; m++)
