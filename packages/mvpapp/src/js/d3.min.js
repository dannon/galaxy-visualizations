...
(function (t, n) {
    ...
    function h(t, n, e) {
        var r = (n - t) / Math.max(0, e),
            ...
            o = r / Math.pow(10, i);
        return i >= 0
            ? (o >= Ys ? 10 : o >= Bs ? 5 : o >= Hs ? 2 : 1) * Math.pow(10, i)
            : -Math.pow(10, -i) / (o >= Ys ? 10 : o >= Bs ? 5 : o >= Hs ? 2 : 1);
    }
    function p(t, n, e) {
    ...
    function T(t, n) {
            ...
            (b = b.merge(b.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000"))),
                ...
                (S = S.merge(
                    N.append("text")
                        .attr("fill", "#000")
                        .attr(f, s * d)
                        .attr("dy", t === Xs ? "0em" : t === $s ? "0.71em" : "0.32em")
                )),
                e !== m &&
                    ((b = b.transition(e)),
                    (w = w.transition(e)),
                    ...
                    N.attr("opacity", Zs).attr("transform", function (t) {
                ...
                m
                    ...
                    .attr("text-anchor", t === Vs ? "start" : t === Ws ? "end" : "middle"),
                m.each(function () {
                    this.__axis = y;
                });
        }
        ...
        return (
            ...
            (e.ticks = function () {
                return (r = js.call(arguments)), e;
            }),
            (e.tickArguments = function (t) {
                return arguments.length ? ((r = null == t ? [] : js.call(t)), e) : r.slice();
            }),
            (e.tickValues = function (t) {
                return arguments.length ? ((i = null == t ? null : js.call(t)), e) : i && i.slice();
            }),
    ...
    function S(t, n, e) {
        for (var r = 0, i = t.length; r < i; ++r)
            if (t[r].name === n) {
                (t[r] = Gs), (t = t.slice(0, r).concat(t.slice(r + 1)));
                break;
            }
    ...
    function E(t) {
        ...
        return (
            ...
            Js.hasOwnProperty(n) ? { space: Js[n], local: t } : t
        );
    }
    function A(t) {
        var n = E(t);
                ...
                : function (t) {
                      return function () {
                          var n = this.ownerDocument,
                              e = this.namespaceURI;
                          return e === Qs && n.documentElement.namespaceURI === Qs
                              ? n.createElement(t)
    ...
    function F(t) {
        var n = U();
        return n.changedTouches && (n = n.changedTouches[0]), O(t, n);
    }
    function I() {}
    function Y(t) {
        return null == t
    ...
    function V(t, n, e, r, i, o) {
        for (var u, a = 0, c = n.length, s = o.length; a < s; ++a)
            (u = n[a]) ? ((u.__data__ = o[a]), (r[a] = u)) : (e[a] = new X(t, o[a]));
    ...
    function ht(t, n, e) {
        ...
        for (var r, i = 0, o = n ? n.length : 0; i < o; ++i) if ((r = n[i]).identifier === e) return O(t, r);
        return null;
    }
    function pt() {
    ...
    function kt(t) {
        ...
        return (
            ...
            (n = lf.exec(t))
                ...
                : (n = df.exec(t))
                ? new zt((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
                : (n = vf.exec(t))
                ? Et(n[1], n[2], n[3], n[4])
                : (n = gf.exec(t))
                ? Et((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
                : (n = _f.exec(t))
                ? Pt(n[1], n[2] / 100, n[3] / 100, 1)
                : (n = yf.exec(t))
                ? Pt(n[1], n[2] / 100, n[3] / 100, n[4])
                : mf.hasOwnProperty(t)
                ? St(mf[t])
                : "transparent" === t
    ...
    function At(t) {
        return t instanceof Nt || (t = kt(t)), t ? ((t = t.rgb()), new zt(t.r, t.g, t.b, t.opacity)) : new zt();
    }
    function Ct(t, n, e, r) {
    ...
    function Rt(t, n, e, r) {
        return 1 === arguments.length
            ? (function (t) {
                  ...
                  return (
                      a
                          ? ((u = n === o ? (e - r) / a + 6 * (e < r) : e === o ? (r - n) / a + 2 : (n - e) / a + 4),
                            (a /= c < 0.5 ? o + i : 2 - o - i),
                            (u *= 60))
                          : (a = c > 0 && c < 1 ? 0 : u),
    ...
    function Dt(t) {
        ...
        var e = Bt(t.r),
            r = Bt(t.g),
            i = Bt(t.b),
            o = Ft((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / wf),
            u = Ft((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Mf);
        return new Ot(
            116 * u - 16,
            500 * (o - u),
            200 * (u - Ft((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / Tf)),
            t.opacity
        );
    }
    function Ut(t, n, e, r) {
        return 1 === arguments.length ? Dt(t) : new Ot(t, n, e, null == r ? 1 : r);
    }
    function Ot(t, n, e, r) {
        (this.l = +t), (this.a = +n), (this.b = +e), (this.opacity = +r);
    }
    function Ft(t) {
        return t > Ef ? Math.pow(t, 1 / 3) : t / Sf + Nf;
    }
    function It(t) {
        return t > kf ? t * t * t : Sf * (t - Nf);
    }
    function Yt(t) {
    ...
    function an(t, n) {
        var e,
            r,
            i,
            o = (jf.lastIndex = Xf.lastIndex = 0),
            u = -1,
            a = [],
            c = [];
        for (t += "", n += ""; (e = jf.exec(t)) && (r = Xf.exec(n)); )
            (i = r.index) > o && ((i = n.slice(o, i)), a[u] ? (a[u] += i) : (a[++u] = i)),
                (e = e[0]) === (r = r[0])
                    ? a[u]
                        ? (a[u] += r)
                        : (a[++u] = r)
                ...
                (function (t, n, e, o) {
                    t !== n
                        ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
                          o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: on(t, n) }))
                        : n && e.push(i(e) + "rotate(" + n + r);
                })(o.rotate, u.rotate, a, c),
                (function (t, n, e, o) {
                    t !== n
                        ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: on(t, n) })
    ...
    function pn(t, n) {
        ...
        if (h < Kf)
            (r = Math.log(s / u) / Gf),
                (e = function (t) {
                    return [i + t * f, o + t * l, u * Math.exp(Gf * t * r)];
                });
        else {
            var p = Math.sqrt(h),
    ...
    function bn() {
        _n(), ++ul;
        for (var t, n = Ff; n; ) (t = ll - n._time) >= 0 && n._call.call(null, t), (n = n._next);
        --ul;
    }
    function wn() {
                ...
                (function () {
                    ...
                    for (; e; )
                        e._call
                            ...
                            : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (Ff = n)));
                    (If = t), Tn(r);
                })(),
                (ll = 0);
        }
    ...
    function Tn(t) {
        if (!ul) {
            ...
            t - ll > 24
                ? (t < 1 / 0 && (al = setTimeout(wn, t - pl.now() - hl)), cl && (cl = clearInterval(cl)))
                : (cl || ((fl = pl.now()), (cl = setInterval(Mn, sl))), (ul = 1), dl(wn));
        }
    }
    function Nn(t, n, e) {
        var r = new mn();
    ...
    function kn(t, n, e, r, i, o) {
        ...
        (function (t, n, e) {
                    ...
                    if ((h = a[s]).name === e.name) {
                        ...
                        h.state === bl
                            ? ((h.state = Ml),
                              ...
                              delete a[s])
                            : +s < n && ((h.state = Ml), h.timer.stop(), delete a[s]);
                    }
                if (
                    (Nn(function () {
                        e.state === xl && ((e.state = bl), e.timer.restart(i, e.delay, e.time), i(c));
                    }),
                    (e.state = ml),
                    e.on.call("start", t, t.__data__, e.index, e.group),
                    e.state === ml)
                ) {
                    for (e.state = xl, u = new Array((l = e.tween.length)), s = 0, f = -1; s < l; ++s)
                ...
                for (
                    var r =
                            n < e.duration
                                ...
                                : (e.timer.restart(o), (e.state = wl), 1),
                        i = -1,
                        a = u.length;
                    ++i < a;
            ...
            (a[n] = e),
                (e.timer = xn(
                    function (t) {
                        (e.state = yl), e.timer.restart(r, e.delay, e.time), e.delay <= t && r(t - e.delay);
                    },
                    0,
                    e.time
                ));
    ...
    function Sn(t, n) {
        var e = An(t, n);
        if (e.state > _l) throw new Error("too late; already scheduled");
        return e;
    }
    function En(t, n) {
        var e = An(t, n);
        if (e.state > ml) throw new Error("too late; already started");
        return e;
    }
    function An(t, n) {
    ...
    function Pn(t, n) {
        var e;
        return ("number" == typeof n ? on : n instanceof kt ? Yf : (e = kt(n)) ? ((n = e), Yf) : an)(t, n);
    }
    function Rn(t, n, e, r) {
    ...
    function Bn(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]); ) if (!(t = t.parentNode)) return (Zl.time = _n()), Zl;
        return e;
    }
    function Hn(t) {
        return function () {
    ...
    function Qn(n) {
        ...
        function u() {
            ...
            function o() {
                ...
                switch (((_ = D[0] - q[0]), (y = D[1] - q[1]), T)) {
                    ...
                    case Kl:
                        N < 0
                            ? ((_ = Math.max(C - a, Math.min(P - a, _))), (s = a + _), (d = p))
                            : N > 0 && ((_ = Math.max(C - p, Math.min(P - p, _))), (s = a), (d = p + _)),
                            k < 0
                                ? ((y = Math.max(z - l, Math.min(R - l, y))), (h = l + y), (g = v))
                                : k > 0 && ((y = Math.max(z - v, Math.min(R - v, y))), (h = l), (g = v + y));
                        break;
                    case th:
                ...
                d < s &&
                    ...
                    (s = d),
                    (d = t),
                    M in oh && I.attr("cursor", ih[(M = oh[M])])),
                    g < h &&
                        ((k *= -1),
                        (t = l),
                        (l = v),
                        ...
                        (h = g),
                        (g = t),
                        M in uh && I.attr("cursor", ih[(M = uh[M])])),
            ...
            function u() {
                ...
                O.attr("pointer-events", "all"),
                    I.attr("cursor", ih.overlay),
                    S.selection && (A = S.selection),
                    Gn(A) && ((S.selection = null), r.call(w)),
                    U.end();
            }
            if (t.event.touches) {
                if (t.event.changedTouches.length < t.event.touches.length) return Xn();
            } else if (c) return;
        ...
        return (
                ...
                t.selection
                    ? t
                          ...
                          .tween("brush", function () {
                              function t(t) {
                                  (u.selection = 1 === t && Gn(s) ? null : f(t)), r.call(o), a.brush();
                              }
                              var o = this,
                                  u = o.__brush,
                                  a = i(o, arguments),
                    ...
                    : t.each(function () {
                          ...
                          Cn(this),
                              (o.selection = null == u || Gn(u) ? null : u),
                              r.call(this),
                              a.start().brush().end();
                      });
            }),
            ...
            (e.filter = function (t) {
                return arguments.length ? ((f = "function" == typeof t ? t : Hn(!!t)), e) : f;
            }),
        ...
        function n(t, n) {
            function e() {
                ...
                var n,
                    e,
                    r = a;
                if (t.charCodeAt(r) === wh) {
                    for (; (a++ < u && t.charCodeAt(a) !== wh) || t.charCodeAt(++a) === wh; );
                    return (
                        (n = a) >= u
                            ? (s = !0)
                            : (e = t.charCodeAt(a++)) === Mh
                            ? (f = !0)
                            : e === Th && ((f = !0), t.charCodeAt(a) === Mh && ++a),
            ...
            var r,
                ...
                s = u <= 0,
                f = !1;
            for (t.charCodeAt(u - 1) === Mh && --u, t.charCodeAt(u - 1) === Th && --u; (r = e()) !== bh; ) {
    ...
    function we(t, n, e) {
        var r = new Me(null == n ? xe : n, null == e ? be : e, NaN, NaN, NaN, NaN);
    ...
    function Oe(n) {
        return (Yh = Ue(n)), (t.format = Yh.format), (t.formatPrefix = Yh.formatPrefix), Yh;
    }
    function Fe(t) {
        return Math.max(0, -Pe(Math.abs(t)));
    }
    function Ie(t, n) {
        return Math.max(0, 3 * Math.max(-8, Math.min(8, Math.floor(Pe(n) / 3))) - Pe(Math.abs(t)));
    }
    function Ye(t, n) {
        return (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Pe(n) - Pe(t)) + 1;
    }
    function Be() {
        return new He();
    }
    ...
    function Xe(t) {
        return t > 1 ? 0 : t < -1 ? Mp : Math.acos(t);
    }
    function Ve(t) {
        return t > 1 ? Tp : t < -1 ? -Tp : Math.asin(t);
    }
    function $e(t) {
        return (t = Up(t / 2)) * t;
    }
    function We() {}
    function Ze(t, n) {
        t && Bp.hasOwnProperty(t.type) && Bp[t.type](t, n);
    }
    function Ge(t, n, e) {
        var r,
            i = -1,
    ...
    function Je(t, n) {
        t && Yp.hasOwnProperty(t.type) ? Yp[t.type](t, n) : Ze(t, n);
    }
    function Ke() {
        Xp.point = nr;
    }
    ...
    function nr(t, n) {
        (Xp.point = er), (Hh = t), (jh = n), (Xh = t *= Ep), (Vh = Pp((n = (n *= Ep) / 2 + Np))), ($h = Up(n));
    }
    function er(t, n) {
        n = (n *= Ep) / 2 + Np;
        var e = (t *= Ep) - Xh,
    ...
    function fr(t, n) {
        ep.push((rp = [(Wh = t), (Gh = t)])), n < Zh && (Zh = n), n > Qh && (Qh = n);
    }
    function lr(t, n) {
        var e = ir([t * Ep, n * Ep]);
        if (np) {
            ...
            s ^ (a * Jh < c && c < a * t)
                ...
                s
                    ? t < Jh
                        ? _r(Wh, t) > _r(Wh, Gh) && (Gh = t)
                        : _r(t, Gh) > _r(Wh, Gh) && (Wh = t)
                    : Gh >= Wh
                    ? (t < Wh && (Wh = t), t > Gh && (Gh = t))
                    : t > Jh
                    ? _r(Wh, t) > _r(Wh, Gh) && (Gh = t)
    ...
    function pr() {
        (rp[0] = Wh), (rp[1] = Gh), ($p.point = fr), (np = null);
    }
    function dr(t, n) {
        if (np) {
            var e = t - Jh;
    ...
    function gr() {
        dr(Kh, tp), Xp.lineEnd(), Ap(Vp) > bp && (Wh = -(Gh = 180)), (rp[0] = Wh), (rp[1] = Gh), (np = null);
    }
    function _r(t, n) {
    ...
    function br(t, n, e) {
        (up += (t - up) / ++ip), (ap += (n - ap) / ip), (cp += (e - cp) / ip);
    }
    function wr() {
        Wp.point = Mr;
    }
    ...
    function Tr(t, n) {
        ...
        var e = Pp((n *= Ep)),
            ...
            o = Up(n),
            u = zp(
                Fp((u = yp * o - mp * i) * u + (u = mp * r - _p * o) * u + (u = _p * i - yp * r) * u),
                _p * r + yp * i + mp * o
            );
        (op += u),
            (sp += u * (_p + (_p = r))),
    ...
    function Pr(t, n) {
        return [t > Mp ? t - kp : t < -Mp ? t + kp : t, n];
    }
    function Rr(t, n, e) {
        return (t %= kp) ? (n || e ? zr(qr(t), Dr(n, e)) : qr(t)) : n || e ? Dr(n, e) : Pr;
    }
    function Lr(t) {
        return function (n, e) {
            return (n += t), [n > Mp ? n - kp : n < -Mp ? n + kp : n, e];
        };
    }
    function qr(t) {
        var n = Lr(t);
        return (n.invert = Lr(-t)), n;
    }
    function Dr(t, n) {
        function e(t, n) {
            var e = Pp(n),
    ...
    function Ur(t) {
        function n(n) {
            return (n = t(n[0] * Ep, n[1] * Ep)), (n[0] *= Sp), (n[1] *= Sp), n;
        }
        return (
            (t = Rr(t[0] * Ep, t[1] * Ep, t.length > 2 ? t[2] * Ep : 0)),
            (n.invert = function (n) {
                return (n = t.invert(n[0] * Ep, n[1] * Ep)), (n[0] *= Sp), (n[1] *= Sp), n;
            }),
            n
        );
    }
    function Or(t, n, e, r, i, o) {
        if (e) {
            ...
            null == i
                ? ((i = n + r * kp), (o = n - c / 2))
                : ((i = Fr(u, i)), (o = Fr(u, o)), (r > 0 ? i < o : i > o) && (i += r * kp));
            for (var s, f = i; r > 0 ? f > o : f < o; f -= c)
                (s = rr([u, -a * Pp(f), -a * Up(f)])), t.point(s[0], s[1]);
        }
    }
    function Fr(t, n) {
        ((n = ir(n))[0] -= t), sr(n);
    ...
    function Yr(t, n) {
        return Ap(t[0] - n[0]) < bp && Ap(t[1] - n[1]) < bp;
    }
    function Br(t, n, e, r) {
            ...
            (t.forEach(function (t) {
                if (!((n = t.length - 1) <= 0)) {
                    ...
                    if (Yr(r, u)) {
                        ...
                        a.push((e = new Br(r, t, null, !0))),
                            c.push((e.o = new Br(r, null, e, !1))),
                            a.push((e = new Br(u, t, null, !1))),
                            c.push((e.o = new Br(u, null, e, !0)));
                }
            }),
            a.length)
        ) {
    ...
    function Xr(t, n) {
        ...
        for (var a = 0, c = t.length; a < c; ++a)
            if ((f = (s = t[a]).length))
                for (
                    var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + Np, d = Up(p), v = Pp(p), g = 0;
                    g < f;
                    ++g, h = y, d = x, v = b, l = _
                ) {
                    var _ = s[g],
            ...
            var h,
                ...
                x = {
                    ...
                    polygonEnd: function () {
                        ...
                        var t = Xr(h, r);
                        p.length
                            ? (m || (i.polygonStart(), (m = !0)), Hr(p, Wr, t, e, i))
                            : t && (m || (i.polygonStart(), (m = !0)), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
                            m && (i.polygonEnd(), (m = !1)),
                            (p = h = null);
                    },
                    sphere: function () {
    ...
    function Wr(t, n) {
        return ((t = t.x)[0] < 0 ? t[1] - Tp - bp : Tp - t[1]) - ((n = n.x)[0] < 0 ? n[1] - Tp - bp : Tp - n[1]);
    }
    function Zr(t) {
        function n(t, n) {
            return Pp(t) * Pp(n) > i;
        ...
        function e(t, n, e) {
            ...
            if (!(g < 0)) {
                ...
                if (
                    ...
                    N || T < bp
                        ? N
                            ? (w + M > 0) ^ (y[1] < (Ap(y[0] - x) < bp ? w : M))
                            : w <= y[1] && y[1] <= M
                        : (T > Mp) ^ (x <= y[0] && y[0] <= b))
                ) {
                    var k = cr(p, (-d + _) / v);
                    return ar(k, h), [y, rr(k)];
                }
            }
        }
        function r(n, e) {
                ...
                return {
                    ...
                    point: function (l, h) {
                        ...
                        if (
                            (!i && (s = c = v) && t.lineStart(),
                            v !== c &&
                                (!(p = e(i, d)) || Yr(i, p) || Yr(d, p)) &&
                                ((d[0] += bp), (d[1] += bp), (v = n(d[0], d[1]))),
                            v !== c)
                        )
                            (f = 0),
                                v
                            ...
                            g & o ||
                                ...
                                ((f = 0),
                                u
                                    ? (t.lineStart(), t.point(_[0][0], _[0][1]), t.point(_[1][0], _[1][1]), t.lineEnd())
                                    : (t.point(_[1][0], _[1][1]),
                                      t.lineEnd(),
                                      t.lineStart(),
                                      t.point(_[0][0], _[0][1])));
            ...
            function s(o, u) {
                ...
                if ((l && h.push([o, u]), x)) (p = o), (d = u), (v = a), (x = !1), a && (w.lineStart(), w.point(o, u));
                    ...
                    !(function (t, n, e, r, i, o) {
                        ...
                        : (m || (w.lineStart(), w.point(c[0], c[1])), w.point(s[0], s[1]), a || w.lineEnd(), (b = !1));
                }
                (_ = o), (y = u), (m = a);
            }
            var f,
                    ...
                    polygonEnd: function () {
                        var n = (function () {
                                for (var n = 0, e = 0, i = l.length; e < i; ++e)
                                    for (
                                        var o, u, a = l[e], c = 1, s = a.length, f = a[0], h = f[0], p = f[1];
                                        c < s;
                                        ++c
                                    )
                                        (o = h),
    ...
    function Qr() {
        ld.point = ld.lineEnd = We;
    }
    function Jr(t, n) {
        (Zp = t *= Ep), (Gp = Up((n *= Ep))), (Qp = Pp(n)), (ld.point = Kr);
    }
    function Kr(t, n) {
        t *= Ep;
        var e = Up((n *= Ep)),
    ...
    function ti(t) {
        return fd.reset(), Je(t, ld), +fd;
    }
    function ni(t, n) {
        return (hd[0] = t), (hd[1] = n), ti(pd);
    }
    function ei(t, n) {
        return !(!t || !vd.hasOwnProperty(t.type)) && vd[t.type](t, n);
    }
    function ri(t, n) {
        return 0 === ni(t, n);
    }
    function ii(t, n) {
        var e = ni(t[0], t[1]);
        return ni(t[0], n) + ni(n, t[1]) <= e + bp;
    }
    function oi(t, n) {
        return !!Xr(t.map(ui), ai(n));
    }
    function ui(t) {
        return (t = t.map(ai)).pop(), t;
    }
    function ai(t) {
        return [t[0] * Ep, t[1] * Ep];
    }
    function ci(t, n, e) {
        var r = f(t, n - bp, e).concat(n);
        return function (t) {
    ...
    function fi() {
        ...
        function n() {
            return f(Rp(o / _) * _, i, _)
                .map(p)
                .concat(f(Rp(s / y) * y, c, y).map(d))
                .concat(
                    f(Rp(r / v) * v, e, v)
                        .filter(function (t) {
                            return Ap(t % _) > bp;
        ...
        return (
            ...
            (t.precision = function (n) {
                return arguments.length
                    ? ((m = +n), (l = ci(a, u, 90)), (h = si(r, e, m)), (p = ci(s, c, 90)), (d = si(o, i, m)), t)
                    : m;
            }),
            t
                .extentMajor([
    ...
    function pi(t, n) {
        (yd.point = di), (Jp = td = t), (Kp = nd = n);
    }
    function di(t, n) {
        _d.add(nd * t - td * n), (td = t), (nd = n);
    }
    function vi() {
        di(Jp, Kp);
    }
    ...
    function Mi(t, n) {
        (Rd.point = Ti), gi((ed = id = t), (rd = od = n));
    }
    function Ti(t, n) {
        var e = t - id,
            r = n - od,
    ...
    function ki(t, n) {
        (Id.point = Si), (qd = Ud = t), (Dd = Od = n);
    }
    function Si(t, n) {
        (Ud -= t), (Od -= n), Fd.add(Fp(Ud * Ud + Od * Od)), (Ud = t), (Od = n);
    }
    function Ei() {
        this._string = [];
    }
        ...
        return +n
            ? (function (t, n) {
                  function e(r, i, o, u, a, c, s, f, l, h, p, d, v, g) {
                      ...
                      if (m > 4 * n && v--) {
                          var x = u + h,
                              ...
                              C = E - i,
                              z = y * A - _ * C;
                          ((z * z) / m > n || Ap((_ * A + y * C) / m - 0.5) > 0.3 || u * h + a * p + c * d < Bd) &&
                  ...
                  return function (n) {
                      ...
                      function s() {
                          e(_, y, g, m, x, b, l, h, f, p, d, v, Yd, n), (w.lineEnd = u), u();
                      }
                      var f,
                          l,
                          h,
    ...
    function Fi(t) {
        function n(t) {
            return (t = s(t[0] * Ep, t[1] * Ep)), [t[0] * v + u, a - t[1] * v];
        }
        function e(t, n) {
        ...
        return (
            ...
            (n.clipAngle = function (t) {
                return arguments.length ? ((T = +t ? Zr((M = t * Ep)) : ((M = null), ad)), i()) : M * Sp;
            }),
            (n.clipExtent = function (t) {
                return arguments.length
                    ? ((k =
                          null == t
                              ? ((N = f = l = h = null), li)
                              : Gr((N = +t[0][0]), (f = +t[0][1]), (l = +t[1][0]), (h = +t[1][1]))),
                      i())
                    : null == N
                    ? null
                    : [
            ...
            (n.center = function (t) {
                return arguments.length ? ((y = (t[0] % 360) * Ep), (m = (t[1] % 360) * Ep), r()) : [y * Sp, m * Sp];
            }),
            (n.rotate = function (t) {
                return arguments.length
                    ? ((x = (t[0] % 360) * Ep),
                      (b = (t[1] % 360) * Ep),
                      (w = t.length > 2 ? (t[2] % 360) * Ep : 0),
                      r())
                    : [x * Sp, b * Sp, w * Sp];
            }),
            (n.precision = function (t) {
                return arguments.length ? ((E = Ui(e, (S = t * t))), i()) : Fp(S);
            }),
            ...
            function () {
                return (
                    ...
                    (n.invert =
                        o.invert &&
                        function (t) {
                            return (t = s.invert((t[0] - u) / v, (a - t[1]) / v)) && [t[0] * Sp, t[1] * Sp];
                        }),
                    r()
                );
            }
    ...
    function Ii(t) {
        ...
        return (
            (i.parallels = function (t) {
                return arguments.length ? r((n = t[0] * Ep), (e = t[1] * Ep)) : [n * Sp, e * Sp];
            }),
            i
        );
    }
    function Yi(t, n) {
        function e(t, n) {
            var e = Fp(o - 2 * i * Up(n)) / i;
            return [e * Up((t *= i)), u - e * Pp(t)];
        }
        var r = Up(t),
            i = (r + Up(n)) / 2;
        if (Ap(i) < bp)
        ...
        return (
            (e.invert = function (t, n) {
                var e = u - n;
                return [(zp(t, Ap(e)) / i) * Op(e), Ve((o - (t * t + e * e) * i * i) / (2 * i))];
            }),
            e
        );
    }
    function Bi() {
        return Ii(Yi).scale(155.424).center([0, 33.6442]);
    }
    function Hi() {
        return Bi().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
    }
    function ji(t) {
        return function (n, e) {
            var r = Pp(n),
    ...
    function Zi(t, n) {
        function e(t, n) {
            o > 0 ? n < -Tp + bp && (n = -Tp + bp) : n > Tp - bp && (n = Tp - bp);
            var e = o / Dp(Wi(n), i);
            return [e * Up(i * t), o - e * Pp(i * t)];
        }
        var r = Pp(t),
    ...
    function Qi(t, n) {
        ...
        return Ap(i) < bp
            ...
            : ((e.invert = function (t, n) {
                  var e = o - n;
                  return [(zp(t, Ap(e)) / i) * Op(e), o - Op(i) * Fp(t * t + e * e)];
              }),
              e);
    }
    function Ji(t, n) {
        ...
        for (null == n && (n = so); (e = s.pop()); )
            if ((c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length)))
                for (e.children = new Array(u), o = u - 1; o >= 0; --o)
                    s.push((r = e.children[o] = new ho(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
                ...
                e && go(e, n)
                    ...
                    : ((e = (function (t) {
                          ...
                          (o = (function (t, n) {
                              var e, r;
                              if (_o(n, t)) return [n];
                              for (e = 0; e < t.length; ++e) if (vo(n, t[e]) && _o(yo(t[e], n), t)) return [t[e], n];
    ...
    function _o(t, n) {
        for (var e = 0; e < n.length; ++e) if (!go(t, n[e])) return !1;
        return !0;
    }
    function yo(t, n) {
        var e = t.x,
    ...
    function To(t) {
        ...
        t: for (a = 3; a < i; ++a) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = wo(n); (r = r.next) !== e; )
                (u = wo(r)) < o && ((n = r), (o = u));
            e = n.next;
        }
    ...
    function Co(t, n) {
        return function (e) {
            if ((r = e.children)) {
                ...
                if (((o = To(r)), a)) for (i = 0; i < u; ++i) r[i].r -= a;
                e.r = o + a;
            }
        };
    }
    ...
    function Ho(t, n, e, r, i, o) {
        for (
            var u, a, c, s, f, l, h, p, d, v, g, _ = [], y = n.children, m = 0, x = 0, b = y.length, w = n.value;
            m < b;
            ...
            for (
                l = h = f, g = f * f * (v = Math.max(s / c, c / s) / (w * t)), d = Math.max(h / g, g / l);
                x < b;
                ++x
            ) {
                if (
            ...
            _.push((u = { value: f, dice: c < s, children: y.slice(m, x) })),
                u.dice ? Ro(u, e, r, i, w ? (r += (s * f) / w) : o) : Bo(u, e, r, w ? (e += (c * f) / w) : i, o),
                (w -= f),
                (m = x);
        }
        return _;
                        ...
                        (e[r] = (function (t, n) {
                            return function (e, r) {
                                t._tasks[n] &&
                                    ...
                                    (t._tasks[n] = null),
                                    null == t._error &&
                                        (null != e ? Zo(t, e) : ((t._data[n] = r), t._waiting ? Wo(t) : Go(t))));
                            };
                        })(t, n)),
                            --t._waiting,
                            ++t._active,
                            (e = i.apply(null, e)),
                            t._tasks[n] && (t._tasks[n] = e || tv);
                    }
                })(t);
            } catch (n) {
    ...
    function tu(t, n) {
        return function (e, r) {
            var i = Ko(e).mimeType(t).response(n);
            if (null != r) {
    ...
    function eu(t) {
        ...
        return (
            ...
            (n.copy = function () {
                return eu().domain(r).range(t).unknown(i);
            }),
            n
        );
    }
    function ru() {
        ...
        return (
            ...
            (r.copy = function () {
                return ru().domain(i()).range(u).round(a).paddingInner(c).paddingOuter(s).align(l);
            }),
            t()
        );
    }
    ...
    function lu(t, n) {
        function e() {
            return (i = Math.min(a.length, c.length) > 2 ? su : cu), (o = u = null), r;
        }
        function r(n) {
            return (
                o ||
        ...
        return (
            ...
            (r.domain = function (t) {
                return arguments.length ? ((a = dv.call(t, uu)), e()) : a.slice();
            }),
            (r.range = function (t) {
                return arguments.length ? ((c = vv.call(t)), e()) : c.slice();
            }),
            (r.rangeRound = function (t) {
                return (c = vv.call(t)), (s = sn), e();
            }),
            (r.clamp = function (t) {
        ...
        return (
                ...
                return (function (n, e, r) {
                    ...
                    switch ((r = Le(null == r ? ",f" : r)).type) {
                        case "s":
                            ...
                            return (
                                null != r.precision || isNaN((i = Ie(a, c))) || (r.precision = i), t.formatPrefix(r, c)
                            );
                        case "":
                        case "e":
                        case "g":
                        ...
                        case "r":
                            null != r.precision ||
                                isNaN((i = Ye(a, Math.max(Math.abs(o), Math.abs(u))))) ||
            ...
            (n.nice = function (t) {
                ...
                return (
                    ...
                    (r = h(a, c, t)) > 0
                        ? (r = h((a = Math.floor(a / r) * r), (c = Math.ceil(c / r) * r), t))
                        : r < 0 && (r = h((a = Math.ceil(a * r) / r), (c = Math.floor(c * r) / r), t)),
                    r > 0
                        ? ((i[o] = Math.floor(a / r) * r), (i[u] = Math.ceil(c / r) * r), e(i))
                        : r < 0 && ((i[o] = Math.ceil(a * r) / r), (i[u] = Math.floor(c * r) / r), e(i)),
                    n
                );
            }),
            n
    ...
    function du() {
        ...
        return (
            ...
            (t.domain = t.range =
                function (e) {
                    return arguments.length ? ((n = dv.call(e, uu)), t) : n.slice();
                }),
            (t.copy = function () {
                return du().domain(n);
            }),
    ...
    function vu(t, n) {
        var e,
            ...
            u = t[i];
        return (
            u < o && ((e = r), (r = i), (i = e), (e = o), (o = u), (u = e)), (t[r] = n.floor(o)), (t[i] = n.ceil(u)), t
        );
    }
    function gu(t, n) {
    ...
    function wu() {
        function n() {
            return (o = xu(i)), (u = mu(i)), r()[0] < 0 && ((o = bu(o)), (u = bu(u))), e;
        }
    ...
    function Nu() {
        ...
        return (
            ...
            (e.range = function (n) {
                return arguments.length ? ((i = vv.call(n)), t()) : i.slice();
            }),
            (e.quantiles = function () {
                return o.slice();
            }),
            (e.copy = function () {
                return Nu().domain(r).range(i);
            }),
            e
        );
    }
        ...
        return (
            ...
            e &&
                ((i.count = function (n, r) {
                    return yv.setTime(+n), mv.setTime(+r), t(yv), t(mv), Math.floor(e(yv, mv));
                }),
                (i.every = function (t) {
                    return (
                        (t = Math.floor(t)),
    ...
    function Au(t) {
        return Eu(
            ...
            function (t, n) {
                return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * wv) / Mv;
            }
        );
    }
    function Cu(t) {
        ...
        function n(t, n) {
            return function (e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++a < s; )
                    37 === t.charCodeAt(a) &&
                        (u.push(t.slice(c, a)),
                        null != (i = bg[(r = t.charAt(++a))]) ? (r = t.charAt(++a)) : (i = "e" === r ? " " : "0"),
                        (o = n[r]) && (r = o(e, i)),
                        u.push(r),
                        (c = a + 1));
        ...
        function e(t, n) {
            return function (e) {
                ...
                if (("p" in u && (u.H = (u.H % 12) + 12 * u.p), "V" in u)) {
                    ...
                    "w" in u || (u.w = 1),
                        "Z" in u
                            ? ((i = (o = (i = Pu(Ru(u.y))).getUTCDay()) > 4 || 0 === o ? rg.ceil(i) : rg(i)),
                              (i = tg.offset(i, 7 * (u.V - 1))),
                              (u.y = i.getUTCFullYear()),
                              (u.m = i.getUTCMonth()),
                              (u.d = i.getUTCDate() + ((u.w + 6) % 7)))
                            : ((i = (o = (i = n(Ru(u.y))).getDay()) > 4 || 0 === o ? Rv.ceil(i) : Rv(i)),
                              (i = Cv.offset(i, 7 * (u.V - 1))),
                              (u.y = i.getFullYear()),
                              (u.m = i.getMonth()),
                              (u.d = i.getDate() + ((u.w + 6) % 7)));
                } else ("W" in u || "U" in u) && ("w" in u || (u.w = "u" in u ? u.u % 7 : "W" in u ? 1 : 0), (o = "Z" in u ? Pu(Ru(u.y)).getUTCDay() : n(Ru(u.y)).getDay()), (u.m = 0), (u.d = "W" in u ? ((u.w + 6) % 7) + 7 * u.W - ((o + 5) % 7) : u.w + 7 * u.U - ((o + 6) % 7)));
                return "Z" in u ? ((u.H += (u.Z / 100) | 0), (u.M += u.Z % 100), Pu(u)) : n(u);
            };
        }
        function r(t, n, e, r) {
            for (var i, o, u = 0, a = n.length, c = e.length; u < a; ) {
                ...
                if (37 === (i = n.charCodeAt(u++))) {
                    if (((i = n.charAt(u++)), !(o = T[i in bg ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)) return -1;
    ...
    function aa(t, n) {
        return qu(1 + Cv.count(Wv(t), t), n, 3);
    }
    function ca(t, n) {
    ...
    function da(t, n) {
        return qu(Pv.count(Wv(t), t), n, 2);
    }
    function va(t, n) {
        var e = t.getDay();
        return (t = e >= 4 || 0 === e ? Dv(t) : Dv.ceil(t)), qu(Dv.count(Wv(t), t) + (4 === Wv(t).getDay()), n, 2);
    }
    function ga(t) {
        return t.getDay();
    }
    function _a(t, n) {
        return qu(Rv.count(Wv(t), t), n, 2);
    }
    function ya(t, n) {
    ...
    function xa(t) {
        ...
        return (n > 0 ? "-" : ((n *= -1), "+")) + qu((n / 60) | 0, "0", 2) + qu(n % 60, "0", 2);
    }
    function ba(t, n) {
        return qu(t.getUTCDate(), n, 2);
    }
    function wa(t, n) {
        return qu(t.getUTCHours(), n, 2);
    }
    function Ma(t, n) {
        return qu(t.getUTCHours() % 12 || 12, n, 2);
    }
    function Ta(t, n) {
        return qu(1 + tg.count(yg(t), t), n, 3);
    }
    function Na(t, n) {
        return qu(t.getUTCMilliseconds(), n, 3);
    }
    function ka(t, n) {
        return Na(t, n) + "000";
    }
    function Sa(t, n) {
        return qu(t.getUTCMonth() + 1, n, 2);
    }
    function Ea(t, n) {
        return qu(t.getUTCMinutes(), n, 2);
    }
    function Aa(t, n) {
        return qu(t.getUTCSeconds(), n, 2);
    }
    function Ca(t) {
        var n = t.getUTCDay();
        return 0 === n ? 7 : n;
    ...
    function za(t, n) {
        return qu(eg.count(yg(t), t), n, 2);
    }
    function Pa(t, n) {
        var e = t.getUTCDay();
        return (t = e >= 4 || 0 === e ? ug(t) : ug.ceil(t)), qu(ug.count(yg(t), t) + (4 === yg(t).getUTCDay()), n, 2);
    }
    function Ra(t) {
        return t.getUTCDay();
    }
    function La(t, n) {
        return qu(rg.count(yg(t), t), n, 2);
    }
    function qa(t, n) {
        return qu(t.getUTCFullYear() % 100, n, 2);
    }
    function Da(t, n) {
        return qu(t.getUTCFullYear() % 1e4, n, 4);
    }
    function Ua() {
        return "+0000";
    }
    ...
    function Ya(n) {
        return (
            (mg = Lu(n)),
            (t.timeFormat = mg.format),
            (t.timeParse = mg.parse),
            (t.utcFormat = mg.utcFormat),
            (t.utcParse = mg.utcParse),
            mg
        );
    }
    function Ba(t) {
    ...
    function ja(t, n, r, i, o, u, a, c, s) {
        ...
        function l(n, r, i, o) {
            if ((null == n && (n = 10), "number" == typeof n)) {
                ...
                a === T.length
                    ? ((o = p(r / Lg, i / Lg, n)), (n = t))
                    : a
                    ? ((o = (a = T[u / T[a - 1][2] < T[a][2] / u ? a - 1 : a])[1]), (n = a[0]))
        ...
        return (
            ...
            (h.domain = function (t) {
                return arguments.length ? v(dv.call(t, Ha)) : v().map(Ba);
            }),
            ...
            (h.nice = function (t, n) {
                var e = v();
                return (t = l(t, e[0], e[e.length - 1], n)) ? v(vu(e, t)) : h;
            }),
            (h.copy = function () {
                return fu(h, ja(t, n, r, i, o, u, a, c, s));
            }),
            h
        );
    }
    ...
    function Za(t) {
        return t >= 1 ? e_ : t <= -1 ? -e_ : Math.asin(t);
    }
    function Ga(t) {
    ...
    function nc(t, n, e, r, i, o, u) {
        ...
        return (
            ...
            { cx: T, cy: N, x01: -f, y01: -l, x11: T * (i / b - 1), y11: N * (i / b - 1) }
        );
    }
    function ec(t) {
        this._context = t;
    ...
    function uc() {
        ...
        return (
            (t.x = function (e) {
                return arguments.length ? ((n = "function" == typeof e ? e : Wa(+e)), t) : n;
            }),
            (t.y = function (n) {
                return arguments.length ? ((e = "function" == typeof n ? n : Wa(+n)), t) : e;
            }),
            (t.defined = function (n) {
                return arguments.length ? ((r = "function" == typeof n ? n : Wa(!!n)), t) : r;
            }),
            (t.curve = function (n) {
    ...
    function ac() {
        ...
        function n() {
            return uc().defined(u).curve(c).context(a);
        }
        var e = ic,
            r = null,
            i = Wa(0),
        ...
        return (
            (t.x = function (n) {
                return arguments.length ? ((e = "function" == typeof n ? n : Wa(+n)), (r = null), t) : e;
            }),
            (t.x0 = function (n) {
                return arguments.length ? ((e = "function" == typeof n ? n : Wa(+n)), t) : e;
            }),
            (t.x1 = function (n) {
                return arguments.length ? ((r = null == n ? null : "function" == typeof n ? n : Wa(+n)), t) : r;
            }),
            (t.y = function (n) {
                return arguments.length ? ((i = "function" == typeof n ? n : Wa(+n)), (o = null), t) : i;
            }),
            (t.y0 = function (n) {
                return arguments.length ? ((i = "function" == typeof n ? n : Wa(+n)), t) : i;
            }),
            (t.y1 = function (n) {
                return arguments.length ? ((o = null == n ? null : "function" == typeof n ? n : Wa(+n)), t) : o;
            }),
            (t.lineX0 = t.lineY0 =
                function () {
                    return n().x(e).y(i);
            ...
            (t.defined = function (n) {
                return arguments.length ? ((u = "function" == typeof n ? n : Wa(!!n)), t) : u;
            }),
            (t.curve = function (n) {
    ...
    function hc(t) {
        ...
        return (
            ...
            delete t.y,
            (t.curve = function (t) {
                return arguments.length ? n(lc(t)) : n()._curve;
            }),
            t
        );
    }
    function pc() {
        return hc(uc().curve(i_));
    }
    function dc() {
        var t = ac().curve(i_),
            n = t.curve,
    ...
    function yc(t) {
        ...
        return (
            ...
            (n.x = function (t) {
                return arguments.length ? ((i = "function" == typeof t ? t : Wa(+t)), n) : i;
            }),
            (n.y = function (t) {
                return arguments.length ? ((o = "function" == typeof t ? t : Wa(+t)), n) : o;
            }),
    ...
    function Oc(t, n, e) {
        var r = t._x1 - t._x0,
            ...
            u = (e - t._y1) / (i || (r < 0 && -0)),
            a = (o * i + u * r) / (r + i);
        return (Uc(o) + Uc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) || 0;
    }
    function Fc(t, n) {
        var e = t._x1 - t._x0;
    ...
    function us(t, n, e, r) {
        ...
        return (
            ...
            e && cs(i, t, n, e),
            r && cs(i, n, t, r),
            P_[t.index].halfedges.push(o),
            P_[n.index].halfedges.push(o),
            i
        );
    }
    function as(t, n, e) {
            ...
            if (((o = r - c), h || !(o < 0))) {
                ...
                if (((o = e - s), p || !(o > 0))) {
                    ...
                    if (((o = i - s), p || !(o < 0))) {
                        ...
                        return (
                            !(f > 0 || l < 1) ||
                            (f > 0 && (t[0] = [c + f * h, s + f * p]), l < 1 && (t[1] = [c + l * h, s + l * p]), !0)
                        );
                    }
                }
            }
                ...
                if (!(h >= -O_)) {
                    var p = c * c + s * s,
                        ...
                        _ =
                            q_.pop() ||
                            new (function () {
                                es(this), (this.x = this.y = this.arc = this.site = this.cy = null);
                            })();
                    (_.arc = t),
                        (_.site = i),
                        (_.x = v + u),
    ...
    function gs(t) {
        var n =
            D_.pop() ||
            new (function () {
                es(this), (this.edge = this.site = this.circle = null);
            })();
        return (n.site = t), n;
    }
    function _s(t) {
        vs(t), z_.remove(t), D_.push(t), es(t);
    }
    function ys(t) {
        var n = t.circle,
            e = n.x,
            ...
            a = [t];
        _s(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < U_ && Math.abs(r - c.circle.cy) < U_; )
            (o = c.P), a.unshift(c), _s(c), (c = o);
        a.unshift(c), vs(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < U_ && Math.abs(r - s.circle.cy) < U_; )
            (u = s.N), a.push(s), _s(s), (s = u);
        a.push(s), vs(s);
        var f,
            l = a.length;
    ...
    function ms(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = z_._; a; )
            if ((r = xs(a, u) - o) > U_) a = a.L;
                ...
                if (
                    ...
                    r > -U_ ? ((n = a.P), (e = a)) : i > -U_ ? ((n = a), (e = a.N)) : (n = e = a);
                    break;
                }
                if (!a.R) {
                    n = a;
        ...
        (function (t) {
            P_[t.index] = { site: t, halfedges: [] };
        })(t);
        var c = gs(t);
        if ((z_.insert(n, c), n || e)) {
            if (n === e)
                return (
                    vs(n), (e = gs(n.site)), z_.insert(c, e), (c.edge = e.edge = us(n.site, c.site)), ds(n), void ds(e)
                );
            if (e) {
                vs(n), vs(e);
                var s = n.site,
    ...
    function Ms(t, n) {
        ...
        for (L_ = [], P_ = new Array(t.length), z_ = new ns(), R_ = new ns(); ; )
            if (((i = C_), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
                (o[0] === e && o[1] === r) || (ms(o), (e = o[0]), (r = o[1])), (o = t.pop());
            else {
                if (!i) break;
                ys(i.arc);
            }
        if (
            ...
            var u = +n[0][0],
                ...
                s = +n[1][1];
            (function (t, n, e, r) {
                for (var i, o = L_.length; o--; )
                    (fs((i = L_[o]), t, n, e, r) &&
                        ss(i, t, n, e, r) &&
                        (Math.abs(i[0][0] - i[1][0]) > U_ || Math.abs(i[0][1] - i[1][1]) > U_)) ||
                        delete L_[o];
            })(u, a, c, s),
                (function (t, n, e, r) {
                    var i,
                        ...
                        if ((o = P_[i])) {
                            ...
                            for (a = 0, s = c.length; a < s; )
                                (d = (p = ps(o, L_[c[a]]))[0]),
                                    ...
                                    (l = (f = hs(o, L_[c[++a % s]]))[0]),
                                    (h = f[1]),
                                    (Math.abs(d - l) > U_ || Math.abs(v - h) > U_) &&
                                        (c.splice(
                                            a,
                                            0,
                                            L_.push(
                                                as(
                                                    u,
                                                    p,
                                                    Math.abs(d - t) < U_ && r - v > U_
                                                        ? [t, Math.abs(l - t) < U_ ? h : r]
                                                        : Math.abs(v - r) < U_ && e - d > U_
                                                        ? [Math.abs(h - r) < U_ ? l : e, r]
                                                        : Math.abs(d - e) < U_ && v - n > U_
                                                        ? [e, Math.abs(l - e) < U_ ? h : n]
                                                        : Math.abs(v - n) < U_ && d - t > U_
                                                        ? [Math.abs(h - n) < U_ ? l : t, n]
                                                        : null
                                                )
                                            ) - 1
                                        ),
    ...
    if (((t.event = null), "undefined" != typeof document)) {
        "onmouseenter" in document.documentElement || (of = { mouseenter: "mouseover", mouseleave: "mouseout" });
    }
    X.prototype = {
        constructor: X,
    ...
    (st.prototype = ft.prototype =
        {
            ...
            enter: function () {
                return new st(this._enter || this._groups.map(j), this._parents);
            },
            exit: function () {
                return new st(this._exit || this._groups.map(j), this._parents);
            },
            merge: function (t) {
                for (
                    var n = this._groups,
            ...
            on: function (t, n, e) {
                var r,
                    ...
                    u = o.length;
                if (!(arguments.length < 2)) {
                    for (a = n ? q : L, null == e && (e = !1), r = 0; r < u; ++r) this.each(a(o[r], n, e));
                    return this;
                }
    ...
    Mt(Nt, kt, {
        ...
        Mt(
            ...
            Tt(Nt, {
                ...
                darker: function (t) {
                    return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Lt(this.h, this.s, this.l * t, this.opacity);
                },
                rgb: function () {
    ...
    Mt(
        ...
        Tt(Nt, {
            brighter: function (t) {
                return (
                    (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Vt(this.h, this.s, this.l * t, this.opacity)
                );
            },
            darker: function (t) {
                return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Vt(this.h, this.s, this.l * t, this.opacity);
            },
            rgb: function () {
    ...
    var qf,
            ...
            function (t) {
                return "none" === t
                    ...
                    : (qf ||
                          ...
                          (Df = document.documentElement),
                          (Uf = document.defaultView)),
                      (qf.style.transform = t),
                      (t = Uf.getComputedStyle(Df.appendChild(qf), null).getPropertyValue("transform")),
                      Df.removeChild(qf),
                      (t = t.slice(7, -1).split(",")),
                      fn(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
            },
            "px, ",
            "px)",
            "deg)"
        ...
        Zf = ln(
            function (t) {
                return null == t
                    ? $f
                    : (Of || (Of = document.createElementNS("http://www.w3.org/2000/svg", "g")),
                      Of.setAttribute("transform", t),
                      (t = Of.transform.baseVal.consolidate())
    ...
    mn.prototype = xn.prototype = {
        ...
        restart: function (t, n, e) {
            ...
            (e = (null == e ? _n() : +e) + (null == n ? 0 : +n)),
                this._next || If === this || (If ? (If._next = this) : (Ff = this), (If = this)),
                (this._call = t),
                (this._time = e),
                Tn();
        },
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
                for (var a, c, s = r[u], f = s.length, l = (o[u] = new Array(f)), h = 0; h < f; ++h)
                    (a = s[h]) &&
                        ...
                        ("__data__" in a && (c.__data__ = a.__data__), (l[h] = c), kn(l[h], n, e, h, l, An(a, e)));
        ...
        selectAll: function (t) {
            ...
            for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
                for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
                    if ((c = s[l])) {
                        for (var h, p = t.call(c, c.__data__, l, s), d = An(c, e), v = 0, g = p.length; v < g; ++v)
                            (h = p[v]) && kn(h, n, e, v, p, d);
                        o.push(p), u.push(c);
                    }
                          ...
                          ? (function (t, n, e) {
                                ...
                                return function () {
                                    var u = G(this, t),
                                        a = e(this);
                                    return (
                                        null == a && (this.style.removeProperty(t), (a = G(this, t))),
                                        u === a ? null : u === r && a === i ? o : (o = n((r = u), (i = a)))
                                    );
                                };
                            })(t, r, zn(this, "style." + t, n))
                          : (function (t, n, e) {
                                var r, i;
                                return function () {
                                    var o = G(this, t);
            ...
            return arguments.length
                ? this.each(
                      ("function" == typeof t
                          ? function (t, n) {
                                return function () {
                                    En(this, t).duration = +n.apply(this, arguments);
                                };
                            }
                          : function (t, n) {
                                return (
                                    (n = +n),
                                    function () {
                                        En(this, t).duration = n;
                                    }
                                );
                            })(n, t)
                  )
                : An(this.node(), n).duration;
        },
        ease: function (t) {
            var n = this._id;
            return arguments.length
    ...
    (ft.prototype.interrupt = function (t) {
        ...
        (ft.prototype.transition = function (t) {
            ...
            t instanceof Rn
                ? ((n = t._id), (t = t._name))
                : ((n = qn()), ((e = Zl).time = _n()), (t = null == t ? null : t + ""));
    ...
    var Gl = [null],
        ...
        rh = {
            name: "xy",
            handles: ["n", "e", "s", "w", "nw", "ne", "se", "sw"].map(Vn),
            input: function (t) {
                return t;
            },
            output: function (t) {
    ...
    Kn.prototype = te.prototype = {
        ...
        arc: function (t, n, e, r, i, o) {
            ...
            null === this._x1
                ? (this._ += "M" + c + "," + s)
                : (Math.abs(this._x1 - c) > 1e-6 || Math.abs(this._y1 - s) > 1e-6) && (this._ += "L" + c + "," + s),
                e &&
                    (l < 0 && (l = (l % _h) + _h),
                    l > yh
                        ? (this._ +=
    ...
    (qh.copy = function () {
        var t,
            n,
            e = new Me(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
            r = this._root;
        if (!r) return e;
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); )
            for (var i = 0; i < 4; ++i)
                (n = r.source[i]) &&
                    (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Te(n)));
        return e;
    }),
        (qh.add = function (t) {
        ...
        (qh.addAll = function (t) {
            ...
            for (e = 0; e < o; ++e)
                isNaN((r = +this._x.call(null, (n = t[e])))) ||
                    ...
                    ((u[e] = r), (a[e] = i), r < c && (c = r), r > f && (f = r), i < s && (s = i), i > l && (l = i));
            for (
        ...
        (qh.find = function (t, n, e) {
            var r,
                ...
                v = this._root;
            for (
                v && d.push(new me(v, f, l, h, p)),
                    null == e ? (e = 1 / 0) : ((f = t - e), (l = n - e), (h = t + e), (p = n + e), (e *= e));
                (c = d.pop());
        ...
        (qh.visit = function (t) {
            ...
            for (c && a.push(new me(c, this._x0, this._y0, this._x1, this._y1)); (n = a.pop()); )
                if (!t((c = n.node), (r = n.x0), (i = n.y0), (o = n.x1), (u = n.y1)) && c.length) {
                    var s = (r + o) / 2,
                        f = (i + u) / 2;
                    (e = c[3]) && a.push(new me(e, s, f, o, u)),
                        (e = c[2]) && a.push(new me(e, r, f, s, u)),
                        (e = c[1]) && a.push(new me(e, s, i, o, f)),
                        (e = c[0]) && a.push(new me(e, r, i, s, f));
                }
            return this;
        }),
            ...
            for (this._root && e.push(new me(this._root, this._x0, this._y0, this._x1, this._y1)); (n = e.pop()); ) {
                ...
                if (i.length) {
                    var o,
                        ...
                        f = (u + c) / 2,
                        l = (a + s) / 2;
                    (o = i[0]) && e.push(new me(o, u, a, f, l)),
                        (o = i[1]) && e.push(new me(o, f, a, c, l)),
                        (o = i[2]) && e.push(new me(o, u, l, f, s)),
                        (o = i[3]) && e.push(new me(o, f, l, c, s));
                }
                r.push(n);
            }
        ...
        Fh = {
            ...
            s: function (t, n) {
                ...
                return o === u
                    ...
                    : "0." + new Array(1 - o).join("0") + ze(t, Math.max(0, n + o - 1))[0];
            },
            X: function (t) {
    ...
    Oe({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }),
        (He.prototype = {
            constructor: He,
            reset: function () {
                this.s = this.t = 0;
            ...
            add: function (t) {
                je(xp, t, this.t), je(this, xp.s, this.s), this.s ? (this.t += xp.t) : (this.s = xp.t);
            },
            valueOf: function () {
                return this.s;
            },
    ...
    var Hh,
        ...
        Bp = {
            ...
            LineString: function (t, n) {
                Ge(t.coordinates, n, 0);
            },
            MultiLineString: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) Ge(e[r], n, 0);
            },
            Polygon: function (t, n) {
                Qe(t.coordinates, n);
            },
            MultiPolygon: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) Qe(e[r], n);
            },
        ...
        Xp = {
            ...
            lineEnd: We,
            polygonStart: function () {
                Hp.reset(), (Xp.lineStart = Ke), (Xp.lineEnd = tr);
            },
            polygonEnd: function () {
                var t = +Hp;
        ...
        $p = {
            ...
            lineEnd: pr,
            polygonStart: function () {
                ($p.point = dr), ($p.lineStart = vr), ($p.lineEnd = gr), Vp.reset(), Xp.polygonStart();
            },
            polygonEnd: function () {
                Xp.polygonEnd(),
                    ($p.point = fr),
                    ($p.lineStart = hr),
                    ($p.lineEnd = pr),
                    Hp < 0 ? ((Wh = -(Gh = 180)), (Zh = -(Qh = 90))) : Vp > bp ? (Qh = 90) : Vp < -bp && (Zh = -90),
                    (rp[0] = Wh),
                    (rp[1] = Gh);
            },
        },
        Wp = {
            ...
            lineEnd: Nr,
            polygonStart: function () {
                (Wp.lineStart = kr), (Wp.lineEnd = Sr);
            },
            polygonEnd: function () {
                (Wp.lineStart = wr), (Wp.lineEnd = Nr);
            },
        };
    Pr.invert = Pr;
    var Zp,
                            ...
                            : i !== a &&
                              ...
                              (r = (function (t, n, e, r) {
                                  var i,
                                      ...
                                      u = Up(t - e);
                                  return Ap(u) > bp
                                      ? Cp((Up(n) * (o = Pp(r)) * Up(e) - Up(r) * (i = Pp(n)) * Up(t)) / (i * o * u))
                                      : (n + r) / 2;
                              })(e, r, o, u)),
                              t.point(i, r),
                              t.lineEnd(),
        ...
        dd = {
            Feature: function (t, n) {
                return ei(t.geometry, n);
            },
            FeatureCollection: function (t, n) {
                for (var e = t.features, r = -1, i = e.length; ++r < i; ) if (ei(e[r].geometry, n)) return !0;
                return !1;
            },
        },
        vd = {
            ...
            MultiPoint: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (ri(e[r], n)) return !0;
                return !1;
            },
            LineString: function (t, n) {
                return ii(t.coordinates, n);
            },
            MultiLineString: function (t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i; ) if (ii(e[r], n)) return !0;
                return !1;
            },
            Polygon: function (t, n) {
            ...
            GeometryCollection: function (t, n) {
                for (var e = t.geometries, r = -1, i = e.length; ++r < i; ) if (ei(e[r], n)) return !0;
                return !1;
            },
        },
        gd = Be(),
        ...
        yd = {
            ...
            lineEnd: We,
            polygonStart: function () {
                (yd.lineStart = hi), (yd.lineEnd = vi);
            },
            polygonEnd: function () {
                (yd.lineStart = yd.lineEnd = yd.point = We), gd.add(Ap(_d)), _d.reset();
            },
            result: function () {
                var t = gd / 2;
                return gd.reset(), t;
        ...
        Md = {
            point: function (t, n) {
                t < md && (md = t), t > bd && (bd = t), n < xd && (xd = n), n > wd && (wd = n);
            },
            lineStart: We,
            lineEnd: We,
            polygonStart: We,
        ...
        Rd = {
            ...
            lineEnd: xi,
            polygonStart: function () {
                (Rd.lineStart = bi), (Rd.lineEnd = wi);
            },
            polygonEnd: function () {
                (Rd.point = gi), (Rd.lineStart = _i), (Rd.lineEnd = xi);
            },
            result: function () {
                var t = Pd ? [Cd / Pd, zd / Pd] : Ad ? [Sd / Ad, Ed / Ad] : kd ? [Td / kd, Nd / kd] : [NaN, NaN];
                return (Td = Nd = kd = Sd = Ed = Ad = Cd = zd = Pd = 0), t;
            },
        };
    Ni.prototype = {
        _radius: 4.5,
        ...
        point: function (t, n) {
            switch (this._point) {
                ...
                case 1:
                    ...
                    break;
                default:
                    null == this._circle && (this._circle = Ai(this._radius)),
    ...
    var Yd = 16,
        ...
        Hd = Ci({
            point: function (t, n) {
                this.stream.point(t * Ep, n * Ep);
            },
        }),
        jd = ji(function (t) {
            return Fp(2 / (1 + t));
        });
    jd.invert = Xi(function (t) {
        return 2 * Ve(t / 2);
    });
    var Xd = ji(function (t) {
        return (t = Xe(t)) && t / Up(t);
    });
    (Xd.invert = Xi(function (t) {
        return t;
    })),
        (Vi.invert = function (t, n) {
            return [t, 2 * Cp(Lp(n)) - Tp];
        }),
        (Gi.invert = Gi),
        (Ji.invert = Xi(Cp)),
        (to.invert = function (t, n) {
            var e,
                r = n,
                i = 25;
            do {
        ...
        (no.invert = Xi(Ve)),
        (eo.invert = Xi(function (t) {
            return 2 * Cp(t);
        })),
        (ro.invert = function (t, n) {
            return [-n, 2 * Cp(Lp(t)) - Tp];
        }),
        (ho.prototype = co.prototype =
            {
                constructor: ho,
                count: function () {
            ...
            function e(t, e, r, i, o) {
                if ((u = t._squarify) && u.ratio === n)
                    for (var u, a, c, s, f, l = -1, h = u.length, p = t.value; ++l < h; ) {
                        ...
                        a.dice
                            ? Ro(a, e, r, i, (r += ((o - r) * a.value) / p))
                            : Bo(a, e, r, (e += ((i - e) * a.value) / p), o),
                            (p -= a.value);
                    }
    ...
    $o.prototype = Qo.prototype = {
        ...
        defer: function (t) {
            ...
            return n.push(t), ++this._waiting, this._tasks.push(n), Wo(this), this;
        },
        abort: function () {
            return null == this._error && Zo(this, new Error("abort")), this;
        },
        await: function (t) {
            if ("function" != typeof t) throw new Error("invalid callback");
        ...
        awaitAll: function (t) {
            if ("function" != typeof t) throw new Error("invalid callback");
            if (this._call) throw new Error("multiple await");
            return (this._call = t), Go(this), this;
        },
    };
    var nv = (function t(n) {
            function e(t, e) {
        ...
        rv = (function t(n) {
            function e() {
                var t = ev.source(n).apply(this, arguments);
                return function () {
                    return Math.exp(t());
                };
            }
        ...
        av = tu("text/html", function (t) {
            return document.createRange().createContextualFragment(t.responseText);
        }),
        cv = tu("application/json", function (t) {
            return JSON.parse(t.responseText);
        }),
        sv = tu("text/plain", function (t) {
            return t.responseText;
        }),
        fv = tu("application/xml", function (t) {
            var n = t.responseXML;
    ...
    var bv = xv.range,
        ...
        Cv = Eu(
            ...
            function (t, n) {
                return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * wv) / 864e5;
            },
            function (t) {
                return t.getDate() - 1;
            }
    ...
    var Ng = "%Y-%m-%dT%H:%M:%S.%LZ",
        kg = Date.prototype.toISOString
            ? function (t) {
                  return t.toISOString();
              }
            : t.utcFormat(Ng),
        Sg = +new Date("2000-01-01T00:00:00.000Z")
            ? function (t) {
                  var n = new Date(t);
        ...
        Fg = ol(Xt(300, 0.5, 0), Xt(-240, 0.5, 1)),
        Ig = ol(Xt(-100, 0.75, 0.35), Xt(80, 1.5, 0.8)),
        Yg = ol(Xt(260, 0.75, 0.35), Xt(80, 1.5, 0.8)),
        Bg = Xt(),
        Hg = Va(
            Xa(
        ...
        b_ = {
            draw: function (t, n) {
                ...
                t.moveTo(r, i),
                    t.lineTo(o, u),
                    t.lineTo(a, c),
                    t.lineTo(-0.5 * r - y_ * i, y_ * r + -0.5 * i),
                    t.lineTo(-0.5 * o - y_ * u, y_ * o + -0.5 * u),
                    t.lineTo(-0.5 * a - y_ * c, y_ * a + -0.5 * c),
                    t.lineTo(-0.5 * r + y_ * i, -0.5 * i - y_ * r),
                    t.lineTo(-0.5 * o + y_ * u, -0.5 * u - y_ * o),
                    t.lineTo(-0.5 * a + y_ * c, -0.5 * c - y_ * a),
                    t.closePath();
            },
        },
    ...
    var M_ = (function t(n) {
        function e(t) {
            return 1 === n ? new Tc(t) : new Sc(t, n);
        }
        return (
            (e.beta = function (n) {
                return t(+n);
    ...
    var S_ = (function t(n) {
        function e(t) {
            return n ? new Rc(t, n) : new Ac(t, 0);
        }
        return (
            (e.alpha = function (n) {
                return t(+n);
    ...
    (Dc.prototype = {
        ...
        ((Bc.prototype = Object.create(Yc.prototype)).point = function (t, n) {
        ...
        (ns.prototype = {
            ...
            insert: function (t, n) {
                ...
                if (t) {
                    ...
                    this._
                        ? ((t = os(this._)), (n.P = null), (n.N = t), (t.P = t.L = n), (e = t))
                        : ((n.P = n.N = null), (this._ = n), (e = null));
                for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
                    e === (r = e.U).L
                        ? (i = r.R) && i.C
                            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                            : (t === e.R && (rs(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), is(this, r))
                        : (i = r.L) && i.C
                        ? ((e.C = i.C = !1), (r.C = !0), (t = r))
                        : (t === e.L && (is(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), rs(this, r)),
                        (e = t.U);
                this._.C = !1;
            },
            remove: function (t) {
                ...
                if (
                    ...
                    if (t && t.C) t.C = !1;
                        ...
                        do {
                            ...
                            if (t === i.L) {
                                if (
                                    ((n = i.R).C && ((n.C = !1), (i.C = !0), rs(this, i), (n = i.R)),
                                    (n.L && n.L.C) || (n.R && n.R.C))
                                ) {
                                    (n.R && n.R.C) || ((n.L.C = !1), (n.C = !0), is(this, n), (n = i.R)),
                                        (n.C = i.C),
                                        (i.C = n.R.C = !1),
                                        rs(this, i),
                                        (t = this._);
                                ...
                                ((n = i.L).C && ((n.C = !1), (i.C = !0), is(this, i), (n = i.L)),
                                (n.L && n.L.C) || (n.R && n.R.C))
                            ) {
                                (n.L && n.L.C) || ((n.R.C = !1), (n.C = !0), rs(this, n), (n = i.L)),
                                    (n.C = i.C),
                                    (i.C = n.L.C = !1),
                                    is(this, i),
                                    (t = this._);
            ...
            return (
                this.cells.forEach(function (e, r) {
                    if ((o = (i = e.halfedges).length))
                        for (
                            var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left;
                            ++c < o;
    ...
    (ks.prototype = Ns.prototype),
        ...
        (t.histogram = function () {
            ...
            return (
                ...
                (t.thresholds = function (n) {
                    return arguments.length
                        ? ((r = "function" == typeof n ? n : Array.isArray(n) ? c(Fs.call(n)) : c(n)), t)
                        : r;
                }),
                t
            );
        ...
        (t.thresholdFreedmanDiaconis = function (t, e, r) {
            return (
                (t = Is.call(t, i).sort(n)),
                Math.ceil((r - e) / (2 * (v(t, 0.75) - v(t, 0.25)) * Math.pow(t.length, -1 / 3)))
            );
        }),
        ...
        (t.chord = function () {
                ...
                for (s = -1; ++s < h; )
                    for (l = s - 1; ++l < h; ) {
                        var T = y[l * h + s],
                            N = y[s * h + l];
                        (T.value || N.value) &&
                            g.push(T.value < N.value ? { source: N, target: T } : { source: T, target: N });
                    }
                return i ? g.sort(i) : g;
            }
            var n = 0,
            ...
            return (
                (t.padAngle = function (e) {
                    return arguments.length ? ((n = dh(0, e)), t) : n;
                }),
        ...
        (t.ribbon = function () {
            function t() {
                ...
                if (
                    ...
                    u.moveTo(p, d),
                    u.arc(0, 0, f, l, h),
                    (l === g && h === _) || (u.quadraticCurveTo(0, 0, v * sh(g), v * fh(g)), u.arc(0, 0, v, g, _)),
            ...
            return (
                (t.radius = function (n) {
                    return arguments.length ? ((r = "function" == typeof n ? n : Jn(+n)), t) : r;
                }),
                (t.startAngle = function (n) {
                    return arguments.length ? ((i = "function" == typeof n ? n : Jn(+n)), t) : i;
                }),
                (t.endAngle = function (n) {
                    return arguments.length ? ((o = "function" == typeof n ? n : Jn(+n)), t) : o;
                }),
                (t.source = function (e) {
        ...
        (t.nest = function () {
            function t(n, i, u, a) {
                ...
                for (var c, s, f, l = -1, h = n.length, p = o[i++], d = ae(), v = u(); ++l < h; )
        ...
        (t.drag = function () {
            ...
            function e() {
                if (!h && p.apply(this, arguments)) {
                    ...
                    n &&
                        (lt(t.event.view).on("mousemove.drag", r, !0).on("mouseup.drag", i, !0),
                        vt(t.event.view),
                        pt(),
                        (l = !1),
                        (s = t.event.clientX),
            ...
            function i() {
                lt(t.event.view).on("mousemove.drag mouseup.drag", null), gt(t.event.view, l), dt(), _.mouse("end");
            }
            function o() {
            ...
            function c(e, r, i, o, u) {
                var a,
                    ...
                    l = y.copy();
                if (
                    D(new yt(n, "beforestart", a, e, m, f[0], f[1], 0, 0, l), function () {
                        return (
                    ...
                    return function t(h) {
                        ...
                        D(new yt(n, h, a, e, p, f[0] + c, f[1] + s, f[0] - d[0], f[1] - d[1], l), l.apply, l, [
                            h,
                            o,
                            u,
                        ]);
            ...
            return (
                (n.filter = function (t) {
                    return arguments.length ? ((p = "function" == typeof t ? t : _t(!!t)), n) : p;
                }),
                (n.container = function (t) {
                    return arguments.length ? ((d = "function" == typeof t ? t : _t(t)), n) : d;
                }),
                (n.subject = function (t) {
                    return arguments.length ? ((v = "function" == typeof t ? t : _t(t)), n) : v;
                }),
                (n.touchable = function (t) {
                    return arguments.length ? ((g = "function" == typeof t ? t : _t(!!t)), n) : g;
                }),
                (n.on = function () {
        ...
        (t.easeSinIn = function (t) {
            return 1 - Math.cos(t * zl);
        }),
        (t.easeSinOut = function (t) {
            return Math.sin(t * zl);
        }),
        (t.easeSinInOut = On),
        (t.easeExp = Fn),
        ...
        (t.forceCollide = function (t) {
            function n() {
                for (var t, n, r, c, s, f, l, h = i.length, p = 0; p < a; ++p)
                    for (n = we(i, Ne, ke).visitAfter(e), t = 0; t < h; ++t)
                        (r = i[t]),
                            (f = o[r.index]),
                            (l = f * f),
                            (c = r.x + r.vx),
            ...
            var i,
                ...
                a = 1;
            return (
                "function" != typeof t && (t = ge(null == t ? 1 : +t)),
                ...
                (n.radius = function (e) {
                    return arguments.length ? ((t = "function" == typeof e ? e : ge(+e)), r(), n) : t;
                }),
                n
            );
        }),
        (t.forceLink = function (t) {
            function n(n) {
                for (var e = 0, r = t.length; e < p; ++e)
                    for (var i, a, c, f, l, h, d, v = 0; v < r; ++v)
                        (a = (i = t[v]).source),
                            (f = (c = i.target).x + c.vx - a.x - a.vx || _e()),
                            (l = c.y + c.vy - a.y - a.vy || _e()),
            ...
            function e() {
                if (a) {
                    ...
                    for (n = 0, c = new Array(l); n < h; ++n)
                        ((e = t[n]).index = n),
                            "object" != typeof e.source && (e.source = Ee(p, e.source)),
                            "object" != typeof e.target && (e.target = Ee(p, e.target)),
            ...
            return (
                ...
                (n.strength = function (t) {
                    return arguments.length ? ((l = "function" == typeof t ? t : ge(+t)), r(), n) : l;
                }),
                (n.distance = function (t) {
                    return arguments.length ? ((h = "function" == typeof t ? t : ge(+t)), i(), n) : h;
                }),
                n
            );
        }),
        (t.forceManyBody = function () {
            ...
            return (
                ...
                (t.strength = function (e) {
                    return arguments.length ? ((c = "function" == typeof e ? e : ge(+e)), n(), t) : c;
                }),
        ...
        (t.forceRadial = function (t, n, e) {
            ...
            return (
                ...
                (r.strength = function (t) {
                    return arguments.length ? ((c = "function" == typeof t ? t : ge(+t)), i(), r) : c;
                }),
                (r.radius = function (n) {
                    return arguments.length ? ((t = "function" == typeof n ? n : ge(+n)), i(), r) : t;
                }),
                (r.x = function (t) {
        ...
        (t.forceSimulation = function (t) {
            ...
            function e() {
                ...
                for (
                    ...
                    null == (e = t[n]).fx ? (e.x += e.vx *= f) : ((e.x = e.fx), (e.vx = 0)),
        ...
        (t.forceX = function (t) {
            ...
            var r,
                ...
                u = ge(0.1);
            return (
                "function" != typeof t && (t = ge(null == t ? 0 : +t)),
                (n.initialize = function (t) {
                    (r = t), e();
                }),
                (n.strength = function (t) {
                    return arguments.length ? ((u = "function" == typeof t ? t : ge(+t)), e(), n) : u;
                }),
                (n.x = function (r) {
                    return arguments.length ? ((t = "function" == typeof r ? r : ge(+r)), e(), n) : t;
                }),
                n
            );
        }),
        ...
        (t.formatDefaultLocale = Oe),
        (t.formatLocale = Ue),
        (t.formatSpecifier = Le),
        (t.precisionFixed = Fe),
        (t.precisionPrefix = Ie),
        (t.precisionRound = Ye),
        (t.geoArea = function (t) {
            return jp.reset(), Je(t, Xp), 2 * jp;
        }),
        (t.geoBounds = function (t) {
            var n, e, r, i, o, u, a;
            if (((Qh = Gh = -(Wh = Zh = 1 / 0)), (ep = []), Je(t, $p), (e = ep.length))) {
                for (ep.sort(yr), n = 1, o = [(r = ep[0])]; n < e; ++n)
                    mr(r, (i = ep[n])[0]) || mr(r, i[1])
                        ? (_r(r[0], i[1]) > _r(r[0], r[1]) && (r[1] = i[1]),
                          _r(i[0], r[1]) > _r(r[0], r[1]) && (r[0] = i[0]))
                        : o.push((r = i));
                for (u = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
                    (i = o[n]), (a = _r(r[1], i[0])) > u && ((u = a), (Wh = i[0]), (Gh = r[1]));
            }
            return (
                (ep = rp = null),
                Wh === 1 / 0 || Zh === 1 / 0
        ...
        (t.geoCentroid = function (t) {
            ...
            return i < wp &&
                ...
                (e = fp),
                (r = lp),
                op < bp && ((n = up), (e = ap), (r = cp)),
                (i = n * n + e * e + r * r) < wp)
                ? [NaN, NaN]
                : [zp(e, n) * Sp, Ve(r / Fp(i)) * Sp];
        }),
        (t.geoCircle = function () {
            ...
            var n,
                ...
                u = {
                    point: function (t, r) {
                        n.push((t = e(t, r))), (t[0] *= Sp), (t[1] *= Sp);
                    },
                };
            return (
                (t.center = function (n) {
                    return arguments.length ? ((r = "function" == typeof n ? n : Cr([+n[0], +n[1]])), t) : r;
                }),
                (t.radius = function (n) {
                    return arguments.length ? ((i = "function" == typeof n ? n : Cr(+n)), t) : i;
                }),
                (t.precision = function (n) {
                    return arguments.length ? ((o = "function" == typeof n ? n : Cr(+n)), t) : o;
                }),
                t
            );
        }),
        (t.geoClipAntimeridian = ad),
        (t.geoClipCircle = Zr),
        (t.geoClipExtent = function () {
            ...
            return (e = {
                stream: function (e) {
                    return t && n === e ? t : (t = Gr(r, i, o, u)((n = e)));
                },
                extent: function (a) {
                    return arguments.length
        ...
        (t.geoClipRectangle = Gr),
        (t.geoContains = function (t, n) {
            return (t && dd.hasOwnProperty(t.type) ? dd[t.type] : ei)(t, n);
        }),
        (t.geoDistance = ni),
        (t.geoGraticule = fi),
        ...
        (t.geoPath = function (t, n) {
            function e(t) {
                return (
                    t && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), Je(t, r(i))), i.result()
                );
            }
            var r,
                i,
            ...
            return (
                (e.area = function (t) {
                    return Je(t, r(yd)), yd.result();
                }),
                (e.measure = function (t) {
                    return Je(t, r(Id)), Id.result();
                }),
                (e.bounds = function (t) {
                    return Je(t, r(Md)), Md.result();
                }),
                (e.centroid = function (t) {
                    return Je(t, r(Rd)), Rd.result();
                }),
                (e.projection = function (n) {
                    return arguments.length ? ((r = null == n ? ((t = null), li) : (t = n).stream), e) : t;
                }),
                (e.context = function (t) {
                    return arguments.length
                        ? ((i = null == t ? ((n = null), new Ei()) : new Ni((n = t))),
        ...
        (t.geoAlbersUsa = function () {
            ...
            return (
                ...
                (t.scale = function (n) {
                    return arguments.length
                        ? (c.scale(n), s.scale(0.35 * n), f.scale(n), t.translate(c.translate()))
                        : c.scale();
                }),
                (t.translate = function (t) {
                    ...
                    return (
                        ...
                        (o = s
                            ...
                            .clipExtent([
                                [r - 0.425 * e + bp, a + 0.12 * e + bp],
                                [r - 0.214 * e - bp, a + 0.234 * e - bp],
                            ])
                            .stream(l)),
                        (u = f
                            .translate([r - 0.205 * e, a + 0.212 * e])
                            .clipExtent([
                                [r - 0.214 * e + bp, a + 0.166 * e + bp],
                                [r - 0.115 * e - bp, a + 0.234 * e - bp],
                            ])
                            .stream(l)),
                        n()
                    );
        ...
        (t.geoAzimuthalEqualArea = function () {
            return Oi(jd).scale(124.75).clipAngle(179.999);
        }),
        (t.geoAzimuthalEqualAreaRaw = jd),
        (t.geoAzimuthalEquidistant = function () {
            return Oi(Xd).scale(79.4188).clipAngle(179.999);
        }),
        (t.geoAzimuthalEquidistantRaw = Xd),
        (t.geoConicConformal = function () {
            return Ii(Zi).scale(109.5).parallels([30, 30]);
        }),
        (t.geoConicConformalRaw = Zi),
        (t.geoConicEqualArea = Bi),
        (t.geoConicEqualAreaRaw = Yi),
        (t.geoConicEquidistant = function () {
            return Ii(Qi).scale(131.154).center([0, 13.9389]);
        }),
        (t.geoConicEquidistantRaw = Qi),
        (t.geoEquirectangular = function () {
            return Oi(Gi).scale(152.63);
        }),
        (t.geoEquirectangularRaw = Gi),
        (t.geoGnomonic = function () {
            return Oi(Ji).scale(144.049).clipAngle(60);
        }),
        (t.geoGnomonicRaw = Ji),
        (t.geoIdentity = function () {
            ...
            return (u = {
                ...
                clipExtent: function (i) {
                    return arguments.length
                        ? ((d =
                              null == i
                                  ? ((p = n = e = r = null), li)
                                  : Gr((p = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))),
                          t())
                        : null == p
                        ? null
                        : [
                ...
                scale: function (n) {
                    return arguments.length ? ((h = Ki((a = +n) * f, a * l, c, s)), t()) : a;
                },
                translate: function (n) {
                    return arguments.length ? ((h = Ki(a * f, a * l, (c = +n[0]), (s = +n[1]))), t()) : [c, s];
                },
                reflectX: function (n) {
                    return arguments.length ? ((h = Ki(a * (f = n ? -1 : 1), a * l, c, s)), t()) : f < 0;
                },
                reflectY: function (n) {
                    return arguments.length ? ((h = Ki(a * f, a * (l = n ? -1 : 1), c, s)), t()) : l < 0;
                },
        ...
        (t.geoProjection = Oi),
        (t.geoProjectionMutator = Fi),
        (t.geoMercator = function () {
            return $i(Vi).scale(961 / kp);
        }),
        (t.geoMercatorRaw = Vi),
        (t.geoNaturalEarth1 = function () {
            return Oi(to).scale(175.295);
        }),
        (t.geoNaturalEarth1Raw = to),
        (t.geoOrthographic = function () {
            return Oi(no)
                .scale(249.5)
                .clipAngle(90 + bp);
        }),
        (t.geoOrthographicRaw = no),
        (t.geoStereographic = function () {
            return Oi(eo).scale(250).clipAngle(142);
        }),
        (t.geoStereographicRaw = eo),
        ...
        (t.cluster = function () {
            function t(t) {
                ...
                t.eachAfter(function (t) {
                    ...
                    e
                        ? ((t.x = (function (t) {
                              return t.reduce(oo, 0) / t.length;
                          })(e)),
                          (t.y = (function (t) {
                              return 1 + t.reduce(uo, 0);
                          })(e)))
        ...
        (t.pack = function () {
            function t(t) {
                return (
                    ...
                    (t.y = r / 2),
                    n
                        ? t.eachBefore(Ao(n)).eachAfter(Co(i, 0.5)).eachBefore(zo(1))
                        : t
                              .eachBefore(Ao(Eo))
                              .eachAfter(Co(ko, 1))
                              .eachAfter(Co(i, t.r / Math.min(e, r)))
                              .eachBefore(zo(Math.min(e, r) / (2 * t.r))),
                    t
                );
            }
            var n = null,
            ...
            return (
                ...
                (t.padding = function (n) {
                    return arguments.length ? ((i = "function" == typeof n ? n : So(+n)), t) : i;
                }),
                t
            );
        }),
        ...
        (t.stratify = function () {
            function t(t) {
                ...
                for (i = 0; i < f; ++i)
                    (r = t[i]),
                        (a = l[i] = new ho(r)),
                        null != (c = n(r, i, t)) && (c += "") && (h[(s = $d + (a.id = c))] = s in h ? Zd : a);
                for (i = 0; i < f; ++i)
        ...
        (t.tree = function () {
                    ...
                    for (var n, e, r, i, o, u = new Yo(t, 0), a = [u]; (n = a.pop()); )
                        if ((r = n._.children))
                            for (n.children = new Array((o = r.length)), i = o - 1; i >= 0; --i)
                                a.push((e = n.children[i] = new Yo(r[i], i))), (e.parent = n);
            ...
            function n(t) {
                ...
                t.parent.A = (function (t, n, e) {
                    if (n) {
                        for (
                            var r, o = t, u = t, a = n, c = o.parent.children[0], s = o.m, f = u.m, l = a.m, h = c.m;
                            (a = Oo(a)), (o = Uo(o)), a && o;
        ...
        (t.treemap = function () {
            function t(t) {
                return (t.x0 = t.y0 = 0), (t.x1 = i), (t.y1 = o), t.eachBefore(n), (u = [0]), r && t.eachBefore(Po), t;
            }
            function n(t) {
                var n = u[t.depth],
                    r = t.x0 + n,
            ...
            return (
                ...
                (t.paddingInner = function (n) {
                    return arguments.length ? ((a = "function" == typeof n ? n : So(+n)), t) : a;
                }),
                ...
                (t.paddingTop = function (n) {
                    return arguments.length ? ((c = "function" == typeof n ? n : So(+n)), t) : c;
                }),
                (t.paddingRight = function (n) {
                    return arguments.length ? ((s = "function" == typeof n ? n : So(+n)), t) : s;
                }),
                (t.paddingBottom = function (n) {
                    return arguments.length ? ((f = "function" == typeof n ? n : So(+n)), t) : f;
                }),
                (t.paddingLeft = function (n) {
                    return arguments.length ? ((l = "function" == typeof n ? n : So(+n)), t) : l;
                }),
                t
            );
        }),
        ...
        (t.treemapSquarify = Qd),
        (t.treemapResquarify = Jd),
        (t.interpolate = cn),
        (t.interpolateArray = en),
        (t.interpolateBasis = Wt),
        (t.interpolateBasisClosed = Zt),
        (t.interpolateDate = rn),
        (t.interpolateNumber = on),
        (t.interpolateObject = un),
        (t.interpolateRound = sn),
        (t.interpolateString = an),
        (t.interpolateTransformCss = Wf),
        (t.interpolateTransformSvg = Zf),
        (t.interpolateZoom = pn),
        (t.interpolateRgb = Yf),
        (t.interpolateRgbBasis = Bf),
        (t.interpolateRgbBasisClosed = Hf),
        (t.interpolateHsl = tl),
        (t.interpolateHslLong = nl),
        ...
        (t.interpolateHcl = el),
        (t.interpolateHclLong = rl),
        (t.interpolateCubehelix = il),
        (t.interpolateCubehelixLong = ol),
        ...
        (t.polygonContains = function (t, n) {
            for (
                var e, r, i = t.length, o = t[i - 1], u = n[0], a = n[1], c = o[0], s = o[1], f = !1, l = 0;
                l < i;
                ++l
            )
                (e = (o = t[l])[0]),
        ...
        (t.randomUniform = nv),
        (t.randomNormal = ev),
        (t.randomLogNormal = rv),
        (t.randomBates = ov),
        (t.randomIrwinHall = iv),
        (t.randomExponential = uv),
        (t.request = Ko),
        (t.html = av),
        (t.json = cv),
        (t.text = sv),
        ...
        (t.scaleSqrt = function () {
            return Tu().exponent(0.5);
        }),
        (t.scaleQuantile = Nu),
        (t.scaleQuantize = ku),
        (t.scaleThreshold = Su),
        (t.scaleTime = function () {
            return ja(Wv, Vv, Pv, Cv, Ev, kv, Tv, xv, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]);
        }),
        (t.scaleUtc = function () {
            return ja(yg, gg, eg, tg, Jv, Gv, Tv, xv, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]);
        }),
        (t.schemeCategory10 = qg),
        (t.schemeCategory20b = Dg),
        (t.schemeCategory20c = Ug),
        (t.schemeCategory20 = Og),
        (t.interpolateCubehelixDefault = Fg),
        (t.interpolateRainbow = function (t) {
            (t < 0 || t > 1) && (t -= Math.floor(t));
            var n = Math.abs(t - 0.5);
            return (Bg.h = 360 * t - 100), (Bg.s = 1.5 - 1.5 * n), (Bg.l = 0.8 - 0.9 * n), Bg + "";
        }),
        (t.interpolateWarm = Ig),
        (t.interpolateCool = Yg),
        (t.interpolateViridis = Hg),
        (t.interpolateMagma = jg),
        (t.interpolateInferno = Xg),
        ...
        (t.touches = function (t, n) {
            null == n && (n = U().touches);
            for (var e = 0, r = n ? n.length : 0, i = new Array(r); e < r; ++e) i[e] = O(t, n[e]);
            return i;
        }),
        (t.window = Z),
        (t.customEvent = D),
        (t.arc = function () {
            function t() {
                ...
                if ((c || (c = t = te()), l < f && ((s = l), (l = f), (f = s)), l > t_))
                    if (d > r_ - t_)
                        c.moveTo(l * Zg(h), l * Jg(h)),
                            c.arc(0, 0, l, h, p, !v),
                            f > t_ && (c.moveTo(f * Zg(p), f * Jg(p)), c.arc(0, 0, f, p, h, v));
                    else {
                        var g,
                            _,
                            y = h,
                                ...
                                var F =
                                    ...
                                    j =
                                        ...
                                        Jg(
                                            ...
                                            })((I * B + Y * H) / (Kg(I * I + Y * Y) * Kg(B * B + H * H))) / 2
                                        ),
                        ...
                        M > t_
                            ? E > t_
                                ? ((g = nc(U, O, z, P, l, E, v)),
                                  ...
                                  E < k
                                      ? c.arc(g.cx, g.cy, E, Wg(g.y01, g.x01), Wg(_.y01, _.x01), !v)
                                      : (c.arc(g.cx, g.cy, E, Wg(g.y01, g.x01), Wg(g.y11, g.x11), !v),
                                        c.arc(
                                            0,
                                            0,
                                            l,
                                            Wg(g.cy + g.y11, g.cx + g.x11),
                                            Wg(_.cy + _.y11, _.cx + _.x11),
                                            !v
                                        ),
                                        c.arc(_.cx, _.cy, E, Wg(_.y11, _.x11), Wg(_.y01, _.x01), !v)))
                            ...
                            f > t_ && w > t_
                                ? S > t_
                                    ? ((g = nc(R, L, q, D, f, -S, v)),
                                      ...
                                      S < k
                                          ? c.arc(g.cx, g.cy, S, Wg(g.y01, g.x01), Wg(_.y01, _.x01), !v)
                                          : (c.arc(g.cx, g.cy, S, Wg(g.y01, g.x01), Wg(g.y11, g.x11), !v),
                                            c.arc(
                                                0,
                                                0,
                                                f,
                                            ...
                                            c.arc(_.cx, _.cy, S, Wg(_.y11, _.x11), Wg(_.y01, _.x01), !v)))
                                    : c.arc(0, 0, f, b, x, v)
                                : c.lineTo(R, L);
                    }
                else c.moveTo(0, 0);
            ...
            return (
                ...
                (t.padRadius = function (n) {
                    return arguments.length ? ((i = null == n ? null : "function" == typeof n ? n : Wa(+n)), t) : i;
                }),
                (t.startAngle = function (n) {
                    return arguments.length ? ((o = "function" == typeof n ? n : Wa(+n)), t) : o;
                }),
                (t.endAngle = function (n) {
                    return arguments.length ? ((u = "function" == typeof n ? n : Wa(+n)), t) : u;
                }),
                (t.padAngle = function (n) {
                    return arguments.length ? ((a = "function" == typeof n ? n : Wa(+n)), t) : a;
                }),
                (t.context = function (n) {
        ...
        (t.pie = function () {
            function t(t) {
                ...
                for (
                    ...
                    (c = d[a]),
                        (f = g + ((l = v[c]) > 0 ? l * s : 0) + m),
                        (v[c] = { data: t[c], index: a, value: l, startAngle: g, endAngle: f, padAngle: y });
                return v;
            }
            var n = sc,
                e = cc,
        ...
        (t.symbol = function () {
            function t() {
                var t;
                if ((r || (r = t = te()), n.apply(this, arguments).draw(r, +e.apply(this, arguments)), t))
        ...
        (t.curveBundle = M_),
        (t.curveCardinalClosed = N_),
        (t.curveCardinalOpen = k_),
        (t.curveCardinal = T_),
        (t.curveCatmullRomClosed = E_),
        (t.curveCatmullRomOpen = A_),
        (t.curveCatmullRom = S_),
        ...
        (t.stack = function () {
            ...
            return (
                (t.keys = function (e) {
                    return arguments.length ? ((n = "function" == typeof e ? e : Wa(o_.call(e))), t) : n;
                }),
                (t.value = function (n) {
                    return arguments.length ? ((i = "function" == typeof n ? n : Wa(+n)), t) : i;
                }),
                (t.order = function (n) {
                    return arguments.length
                        ? ((e = null == n ? Wc : "function" == typeof n ? n : Wa(o_.call(n))), t)
                        : e;
                }),
                (t.offset = function (n) {
                    return arguments.length ? ((r = null == n ? $c : n), t) : r;
                }),
                t
            );
        }),
        ...
        (t.timeInterval = Eu),
        (t.timeMillisecond = xv),
        (t.timeMilliseconds = bv),
        (t.utcMillisecond = xv),
        (t.utcMilliseconds = bv),
        (t.timeSecond = Tv),
        (t.timeSeconds = Nv),
        (t.utcSecond = Tv),
        (t.utcSeconds = Nv),
        ...
        (t.utcYear = yg),
        (t.utcYears = xg),
        (t.timeFormatDefaultLocale = Ya),
        (t.timeFormatLocale = Lu),
        (t.isoFormat = kg),
        (t.isoParse = Sg),
        (t.now = _n),
        (t.timer = xn),
        ...
        (t.active = function (t, n) {
            ...
            if (i) {
                n = null == n ? null : n + "";
                for (r in i) if ((e = i[r]).state > yl && e.name === n) return new Rn([[t]], Gl, n, +r);
            }
            return null;
        }),
        (t.interrupt = Cn),
        (t.voronoi = function () {
            function t(t) {
                return new Ms(
                    t.map(function (r, i) {
                        var o = [Math.round(n(r, i, t) / U_) * U_, Math.round(e(r, i, t) / U_) * U_];
            ...
            return (
                ...
                (t.x = function (e) {
                    return arguments.length ? ((n = "function" == typeof e ? e : Jc(+e)), t) : n;
                }),
                (t.y = function (n) {
                    return arguments.length ? ((e = "function" == typeof n ? n : Jc(+n)), t) : e;
                }),
                (t.extent = function (n) {
                    return arguments.length
                        ? ((r =
        ...
        (t.zoom = function () {
            ...
            function e(t, n) {
                return (n = Math.max(b[0], Math.min(b[1], n))) === t.k ? t : new Ns(n, t.x, t.y);
            }
            function r(t, n, e) {
                var r = n[0] - e[0] * t.k,
                    i = n[1] - e[1] * t.k;
                        ...
                        e = lt(t.event.view)
                            .on(
                                ...
                                function () {
                                    ...
                                    n.zoom(
                                        "mouse",
                                        y(r(n.that.__zoom, (n.mouse[0] = F(n.that)), n.mouse[1]), n.extent, w)
                                    );
                                },
                                !0
                            )
                            .on(
                                "mouseup.zoom",
                                function () {
                                    e.on("mousemove.zoom mouseup.zoom", null), gt(t.event.view, n.moved), Es(), n.end();
                                },
                                !0
                            ),
                        i = F(this),
            ...
            function l() {
                if (g.apply(this, arguments)) {
                    var n,
                        ...
                        c = a.length;
                    for (Ss(), e = 0; e < c; ++e)
                        (i = [(i = ht(this, a, (r = a[e]).identifier)), this.__zoom.invert(i), r.identifier]),
                            o.touch0 ? o.touch1 || (o.touch1 = i) : ((o.touch0 = i), (n = !0));
                    if (d && ((d = clearTimeout(d)), !o.touch1))
                        return o.end(), void ((i = lt(this).on("dblclick.zoom")) && i.apply(this, arguments));
                    n &&
            ...
            function h() {
                var n,
                    ...
                    f = s.length;
                for (Es(), d && (d = clearTimeout(d)), n = 0; n < f; ++n)
                    (o = ht(this, s, (i = s[n]).identifier)),
            ...
            return (
                ...
                (a.prototype = {
                    ...
                    zoom: function (t, n) {
                        ...
                        return (
                            0 == --this.active && (k.splice(this.index, 1), (this.index = -1), this.emit("end")), this
                        );
                    },
                    emit: function (t) {
                        D(
                ...
                (n.wheelDelta = function (t) {
                    return arguments.length ? ((m = "function" == typeof t ? t : Ts(+t)), n) : m;
                }),
                (n.filter = function (t) {
                    return arguments.length ? ((g = "function" == typeof t ? t : Ts(!!t)), n) : g;
                }),
                (n.touchable = function (t) {
                    return arguments.length ? ((x = "function" == typeof t ? t : Ts(!!t)), n) : x;
                }),
                (n.extent = function (t) {
                    return arguments.length
                        ? ((_ =
                ...
                (n.translateExtent = function (t) {
                    return arguments.length
                        ? ((w[0][0] = +t[0][0]), (w[1][0] = +t[1][0]), (w[0][1] = +t[0][1]), (w[1][1] = +t[1][1]), n)
                        : [
                              [w[0][0], w[0][1]],
                              [w[1][0], w[1][1]],
                          ];
