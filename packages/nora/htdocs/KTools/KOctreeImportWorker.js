...
self.addEventListener(
    ...
    function (e) {
        ...
        if (e.data.message == "import") {
            ...
            if (e.data.typ == "TRK") fun = worker_importTRK;
            ...
            fun(
                ...
                function (tracts) {
                    ...
                    try {
                        self.postMessage(
                            { msg: "import_done", md5: md5, tracts: worker_packTractsForTransfer({ content: tracts }) },
                            []
                        );
                    } catch (err) {
                    ...
                    if ((myOctree.fiberstep < 1) | (myOctree.fiberstep == undefined)) myOctree.fiberstep = 1;

                    if (myOctree.fiberstep >= 4) myOctree.fiberstep = 4;
                    ...
                    tracts.tracts.chunk(
                        ...
                        function (i) {
                            self.postMessage({
                                msg: "index_progress",
                                detail: "building octree " + Math.round((100 * i) / tracts.tracts.length) + "%",
                            });
                        },
                        function () {
                            self.postMessage({ msg: "index_progress" });
                        }
                    );
                }
            );
