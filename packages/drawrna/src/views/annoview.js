...
var AnnoView = Backbone.View.extend({
    ...
    render: function () {
        ...
        this.el.innerHTML +=
            ...
            "<button class='btn btn-default dropdown-toggle' type='button' id='menu3' data-toggle='dropdown' style='margin-top: 19px;'>" +
            edefs[2] +
            "<span class='caret'></span></button>" +
        ...
        this.el.innerHTML +=
            "<div class='col-md-1'><button class='btn btn-default' type='button' id='annook' style='margin-top: 19px;'>OK" +
            "</button></div>";
    },
