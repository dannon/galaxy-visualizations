...
var Seqpanel = Backbone.View.extend({
    ...
    render: function () {
        this.el.innerHTML +=
            '<div class="col-md-11 seqin"><input type="text" class="alertfield" id="alert" readonly>' +
            '<input class="textbox" id="seqbox">' +
            '<input class="textbox" id="dotbrbox"></div>';
        this.el.innerHTML +=
            '<div class="col-md-1 seqin">' +
    ...
    drawInput: function () {
        var sequ = [document.getElementById("seqbox").value, document.getElementById("dotbrbox").value];
